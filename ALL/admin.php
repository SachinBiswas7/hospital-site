...
<h1>Admin Panel</h1>
    <div class="nav-menu">
        <a href="#doctor-bookings">Doctor Bookings</a>
        <a href="#icu-bookings">ICU Bookings</a>
        <a href="#package-bookings">Package Bookings</a>
        <a href="#contact-messages">Contact Messages</a>
        <a href="#inquiries">Inquiries</a>
        <a href="#add-doctor">Add Doctor</a>
        <a href="#ambulance-bookings">Ambulance Bookings</a>
    </div>
        ...
        <h2 id="doctor-bookings">Doctor Bookings</h2>
    <table>
        <tr>
            <th>Email</th>
            <th>Doctor Name</th>
    ...
    <h2 id="icu-bookings">ICU Bookings</h2>
        <table>
            <tr>
                <th>Email</th>
                <th>Name</th>
        ...
        <h2 id="package-bookings">Package Bookings</h2>
        <table>
            <tr>
                <th>Email</th>
                <th>Name</th>
        ...
        <h2 id="contact-messages">Contact Messages</h2>
        <table>
            <tr>
                <th>Email</th>
                <th>Message</th>
...
<h2 id="add-doctor">Add Doctor</h2>
...
<h2 id="ambulance-bookings">Ambulance Bookings</h2>
<table>
    <tr>
        <th>Name</th>
        <th>Phone</th>
