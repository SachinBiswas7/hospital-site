...
<div class="box">
    ...
    <div class="box1">
        ...
        <h2 class="boxheader"><a href="inquary.php">Send an inquiry</a></h2>
    </div>
    <div class="box1">
...
<div class="recommendation-bar">
    <p>Check out our recommended packages for personalized care and exclusive benefits! <a href="package.php" class="btn">Explore Packages</a></p>
</div>
